...
class ZHelpMapData : ZHelpData {
	...
	let mapColumnOne: StringsArray = [
		...
		"0COMMA", 		"show or hide preferences", 						"help-inspector-view-c360241147f2",
	...
	let mapColumnThree: StringsArray = [
		...
		"0/", 			"focus (also, manage recents/favorite)", 			"focusing-your-thinking-a53adb16bba",
		...
		"2H", 			"show email, hyperlink popup",		 				"extras-2a9b1a7db21f",
		"1K", 			"un/color the text", 								"extras-2a9b1a7db21f",
		"0L, U",		"convert to lowercase, uppercase", 					"edit-d05d18996df7",
		"1N",			"create/edit note",									"",
		"2O", 			"import from a Seriously file",	 					"cloud-vs-file-f3543f7281ac",
		"1R", 			"show reorder popup",		 						"organize-fcdc44ac04e4",
