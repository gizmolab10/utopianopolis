...
typealias SignalClosure                   = (Any?,   ZSignalKindArray) -> (Void)
...
typealias CKRecordsClosure                = (CKRecordsArray)           -> (Void)
...
typealias StringToPredicateClosure        = (String)                   -> (NSPredicate)
typealias AnyObjectToBooleanClosure       = (AnyObject)                -> (Bool)
typealias ZRecordsToZRecordsClosure       = (ZRecordsArray?)           -> (ZRecordsArray)
typealias ZRelationshipToZoneClosure      = (ZRelationship)            -> (Zone?)
typealias ZPseudoViewToStatusClosure      = (ZPseudoView)              -> (ZTraverseStatus)
