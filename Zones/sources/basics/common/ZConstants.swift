...
let                 kGrayColor = ZColor(calibratedHue: 0.0, saturation: 0.0, brightness: 0.5,  alpha: 1.0)
let                kClearColor = ZColor(calibratedHue: 0.0, saturation: 0.0, brightness: 0.0,  alpha: 0.0)
let                kSystemBlue = ZColor(cgColor: ZColor.systemBlue.cgColor)!
let                 kGridColor = kDarkGrayColor
let                  kEyeImage = ZImage(systemSymbolName: "eye", accessibilityDescription: nil)
let                kStackImage = ZImage(systemSymbolName: "square.stack.3d.up", accessibilityDescription: nil)
let               kSingleImage = ZImage(systemSymbolName: "square.stack.3d.up.slash.fill", accessibilityDescription: nil)
let               kExpandImage = ZImage(systemSymbolName: "rectangle.expand.vertical", accessibilityDescription: nil)
let              kEyebrowImage = ZImage(systemSymbolName: "eyebrow", accessibilityDescription: nil)
let            kLightbulbImage = ZImage(systemSymbolName: "lightbulb", accessibilityDescription: nil)
let           kEyeglassesImage = ZImage(systemSymbolName: "eyeglasses", accessibilityDescription: nil)
let          kNoLightbulbImage = ZImage(systemSymbolName: "lightbulb.slash.fill", accessibilityDescription: nil)
...
let        kDefaultRecordNames = kRootName + kColonSeparator + kRootName + kColonSeparator + kFavoritesRootName + kColonSeparator + kRecentsRootName
