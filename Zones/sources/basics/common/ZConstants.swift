...
let               kSingleImage = ZImage(systemSymbolName: "minus", accessibilityDescription: nil) // square.stack.3d.up.slash.fill
...
let        kAntiLightbulbImage = ZImage(systemSymbolName: "lightbulb.slash.fill", accessibilityDescription: nil)
