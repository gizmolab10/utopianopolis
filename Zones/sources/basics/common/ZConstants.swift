...
let           kDefaultFontSize = CGFloat( 4.0)
...
let                 kBlankLine = NSAttributedString(string:       kNewLine, attributes: [.font : kEssayTitleFont])
let           kDoubleBlankLine = NSAttributedString(string: kDoubleNewLine, attributes: [.font : kEssayTitleFont])
