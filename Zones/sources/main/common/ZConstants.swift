...
let 	   kEssayTitleFontSize = CGFloat(36.0)
let            kEssayTitleFont = ZFont(name: "TimesNewRomanPS-BoldMT", size: kEssayTitleFontSize) ?? ZFont.systemFont(ofSize: kEssayTitleFontSize)
